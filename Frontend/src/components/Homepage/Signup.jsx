        ...
        <Box  
          ...
          <FormControl border='5px' id="email" isRequired>
            ...
            //  border={"1px solid red"}
             ...
             <a href="/"> 
             <Button bg={'#2c1338'} border={["1px solid white"]} h={[5,12,12]} width={[50,50,50]} 
            ...
            <Stack>
              <Text fontSize={{ base: '6px', md: '10px', lg: '13px' }} >
              ...
              marketing communication from Toggl Track. You can opt out anytime. </Text> 
